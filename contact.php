...
<body>
		...
		<div class="flexslider flexslider-banner">
		  <ul class="slides">
		    <li>
				...
				<!--<img src="img/contact.png" alt="Banner 3"/>-->	
		    </li>		    
		  </ul>
		</div>	
	</section>
	...
	<section class="container tm-home-section-1" id="more">
		<div class="row">
			...
			<div class="flexslider effect2 effect2-contact tm-contact-box-1">
				...
				<ul class="slides">
					<li>
						<img src="img/contact-1.png" alt="image" class="contact-image" />
						<div class="contact-text">
							<h2 class="slider-title">Contact</h2>
							<h3 class="slider-subtitle">"For Hotel Reservations, please contact directly to the following address / phone / email only"</h3>
							<p class="slider-description"> 
											Reservations Department<br>
											Maitighar Kathmandu<br>
											Main Line: +977 1 4273999 | Fax: +977 1 4272205<br>
											Email: Email: bookit@gmail.com<br>
	...
	<section class="section-padding-bottom">
		<div class="container">
			...
			<div class="row">
				<!-- contact form -->
				<form action="insertfeedback.php" method="post" class="tm-contact-form">
					<div class="col-lg-6 col-md-6">
					</div> 
					<div class="col-lg-6 col-md-6 tm-contact-form-input">
						<div class="form-group">
							<input type="text"name="user" id="contact_name" class="form-control" placeholder="NAME" />
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<textarea id="contact_message" name="review" class="form-control" rows="6" placeholder="MESSAGE"></textarea>
						</div>
						<div class="form-group">
